...
CLASSIFIERS = [  # https://github.com/github/choosealicense.com/tree/gh-pages/_licenses
    ...
    {{ '# ' if cookiecutter.open_source_license != 'ISC license' else '' }}'License :: OSI Approved :: ISC License (ISCL)',
    {{ '# ' if cookiecutter.open_source_license != 'Apache Software License 2.0' else '' }}'License :: OSI Approved :: Apache Software License',
